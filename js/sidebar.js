class Sidebar{
	...
	draw(){
		...
		ctx.fillText('TIME', ((this.x * 9) * width), ((this.y + 0.01) * width));
		ctx.font = Math.round(0.02 * width) + 'pt "Time"';
		ctx.fillText( ('0' + today.getHours()).slice(-2) + " : " + ('0' + today.getMinutes()).slice(-2) + " : " + ('0' + today.getSeconds()).slice(-2), ((this.x * 9) * width), ((this.y + 0.025) * width));
		ctx.fillRect(((this.x * 5) * width), ((this.y + 0.055) * width), this.w * width * 0.5, 1);
		
		ctx.font = Math.round(0.01 * width) + 'pt "Time"';
		ctx.fillText('SESSION', ((this.x * 9) * width), ((this.y + 0.065) * width));
		ctx.font = Math.round(0.02 * width) + 'pt "Time"';
		...
		ctx.fillText(s, ((this.x * 9) * width), ((this.y + 0.08) * width));
